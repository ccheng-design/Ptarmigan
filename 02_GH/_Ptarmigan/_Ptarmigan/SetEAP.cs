...
namespace Heron
{
    ...
    {
        //Class Constructor
        public SetEAP() : base("Set EarthAnchorPoint", "SetEAP", "Set the Rhino EarthAnchorPoint using either an address or Lat/Lon coordinates", "Ptarmigan","Drone")
        {
        ...
        {
            get { return new Guid("3A9B1B9D-9DED-4B5B-9101-ED57F5239ED8"); }
        }
    }
}
