...
{
    public class MeshBooleanUnion : GH_Component
    {
        /// <summary>
        /// Initializes a new instance of the MyComponent1 class.
        /// </summary>
        public MeshBooleanUnion()
          : base("MeshBooleanUnion", "MeshBD",
              "Computes Union from 2 Sets of Meshes",
              "Ptarmigan", "Mesh")
        {
        }
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            var result = MRDotNet1.MR.DotNet.Boolean(mlMesh, mlMeshB, MRDotNet1.MR.DotNet.BooleanOperation.Union);
        ...
        {
            get { return new Guid("89837567-15E1-4461-B5B3-F05DAB683D4E"); }
        }
    }
}