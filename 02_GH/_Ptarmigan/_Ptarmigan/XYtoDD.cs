...
namespace Heron
{
    ...
    {
        //Class Constructor
        public XYtoDD() : base("XY to Decimal Degrees", "XYtoDD", "Convert X/Y to Decimal Degrees Longitude/Latitude in the WGS84 spatial reference system", "Ptarmigan", "Drone")
        {
        ...
        {
            get { return new Guid("{0B461B47-632B-4145-AA06-157AAFAC1EEA}"); }
        }
    }
}
