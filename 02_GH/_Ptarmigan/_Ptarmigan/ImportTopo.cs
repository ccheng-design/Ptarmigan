...
namespace Heron
{
    ...
    {
        public ImportTopo() : base("Import Topo", "ImportTopo", "Create a topographic mesh from a raster file (IMG, HGT, ASCII, DEM, TIF, etc) clipped to a boundary", "Ptarmigan", "Drone")
        {
        ...
        {
            get { return new Guid("{48DC69A0-DA95-4629-A6F5-A813D88D9187}"); }
        }
    }
}
