...
namespace Clipper2Lib
{
  ...
  public class ClipperOneSideOffset
  {
...
#endif
    public ClipperOneSideOffset(double miterLimit = 2.0,
  ...
  [MethodImpl(MethodImplOptions.AggressiveInlining)]
    ...
    {
      BuildNormals(path); // make sure this is called
      OffsetPolygon(group, path); // only do forward side
    }
